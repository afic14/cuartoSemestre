...
import imagen2 from './imagenes/ima2.png'
import imagen3 from './imagenes/ima3.png'
import imagen4 from './imagenes/ima4.png'
import imagen5 from './imagenes/ima5.jpg'
import App from './App';
...
function Encabezado() {
  return (<div class="flex place-content-center">
    <div class="bg-white">
      ...
      <img src={logo} class="w-40 h-20" alt="Logo" />
    </div>
    ...
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
      ...
      <label for="menu-toggle" class="cursor-pointer md:hidden block">
        <svg class="fill-current text-gray-900" xmlns="http://www.w3.org/2000/svg" width="20"
          height="20" viewBox="0 0 20 20" onClick={() => {
            let menu = document.querySelector('#menu')
            if (oculto) {
              menu.removeAttribute('class')
              oculto = false
...
function Carrucel() {
  return (<div class="carousel relative container mx-auto shadow-2xl m-w-1600 text-black" >
    <div class="carousel-inner relative overflow-hidden w-full">
        ...
        <div class="block h-full w-full bg-indigo-1000 bg-fondocarrucel">
          <div class="md:flex h-full w-full">
            <div class="h-60 w-60 md:h-full md:w-full">
              <img src={imagen2} alt="tipa" class="h-full mx-auto" />
            </div>
      ...
      <div class="carousel-item absolute opacity-0 height:60vh;">
        <div class="block h-full w-full bg-indigo-1000t  bg-fondocarrucel">
          <div class="flex h-full">
            <div class="">
              <img src={imagen3} alt="tipa" class="h-full mx-auto" />
            </div>
            <div class="mx-auto flex text-white">
              <div
                class="flex flex-col my-auto lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide mx-auto">
      ...
      <div class="carousel-item absolute opacity-0 height:60vh;">
        <div class="block h-full w-full bg-indigo-1000t  bg-fondocarrucel">
          <div class="flex h-full">
            <div class="">
              <img src={imagen4} alt="tipa" class="h-full mx-auto" />
            </div>
            <div class="mx-auto flex text-white">
              <div
                class="flex flex-col my-auto lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide mx-auto">
...
function Info() {
  return (<div class="m-auto max-w-6xl p-12 text-gray-800">
...
function Ayuda() {
  return (<div class="top h-64 w-full bg-blue-600 overflow-hidden relative">
...
function Agradecimientos() {
  return (<section class="text-gray-200 bg-white-200">
...
function Footer() {
  return (<footer class='text-white bg-primary'>
    <div class="max-w-6xl m-auto flex flex-wrap justify-left">
      ...
      <div class="p-5 w-1/2 sm:w-4/12 md:w-3/12">
        ...
        <p class="my-3 block hover:text-gray-300 text-sm font-medium duration-700">
